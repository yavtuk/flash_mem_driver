...
#define FMEM_ERASE_VOLUME(fml,d) fmem_determine_erase_volume((fml),(d))
...
/**
 * @brief Determine a volume of memory which will be changed by this write operation.
 *
 * @param f - pointer on "__fmem_layer"
 * @param wdata - pointer on "__fmem_layer_data"
 *
 * @return length of volume
 */
